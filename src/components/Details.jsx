...
const Details = () => {
  return (
    <div className='w-[70%] flex gap-x-4 items-center h-full m-auto p-[10%]'>

        <img className='object-contain h-[80%] w-[40%] ' src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" alt="" />
        ...
        <div className='content w-[50%]'>
            ...
            <p className='mb-[5%] text-xs'>Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday"</p>
